...
.components-section__title--single {
    display: block;
}
...
.components-hero__title-line {
    display: block;
}

.components-hero__title-line--accent {
    color: var(--origam-color__action--primary---fgSubtle, #6d28d9);
}
...
.components-grid-section__header {
...
.components-empty__icon {
    font-size: 3rem;
    color: var(--origam-color__text---tertiary, #737373);
}

.components-empty__title {
    display: block;
    font-size: var(--origam-font-size---lg, 1.125rem);
    font-weight: var(--origam-font__weight---semibold, 600);
    color: var(--origam-color__text---primary, #0a0a0a);
...
.components-category:last-child {
    margin-block-end: 0;
}

.components-category__header {
    display: flex;
    align-items: center;
...
.components-catalog-card__link:hover .components-catalog-card {
    transform: translateY(-2px);
    box-shadow: var(--origam-shadow---md, 0 4px 12px rgba(0, 0, 0, 0.1));
}

.components-catalog-card__link:focus-visible {
...
.components-catalog-card__inner {
...
.components-catalog-card__header {
    display: flex;
    align-items: center;
    gap: var(--origam-space---3, 0.75rem);
}

.components-catalog-card__avatar {
    flex-shrink: 0;
}

.components-catalog-card__name {
    display: block;
    flex: 1;
    font-size: var(--origam-font-size---base, 1rem);
    font-weight: var(--origam-font__weight---semibold, 600);
...
.components-catalog-card__family-icon {
    flex-shrink: 0;
    color: var(--origam-color__text---tertiary, #737373);
}

.components-catalog-card__desc {
    margin: 0;
    font-size: var(--origam-font-size---sm, 0.875rem);
    line-height: 1.55;
    color: var(--origam-color__text---secondary, #525252);
...
.components-catalog-card__family-tags {
    display: flex;
    flex-wrap: wrap;
...
.components-catalog-card__family-chip {
    --origam-chip---background-color: var(--origam-color__surface---sunken, #f5f5f5);
    font-family: var(--origam-font-family---mono, monospace);
}

.components-catalog-card__family-chip--more {
