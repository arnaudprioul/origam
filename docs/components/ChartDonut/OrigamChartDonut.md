...
Donut chart — pie with a centred hole.

Type-specific wrapper around `<OrigamChart type="donut">` with a
...
| `donutHoleSize`      | `number`                                          | `0.6`         | Inner-radius proportion. `0` collapses to a pie, `1` to a zero-thickness ring.               |
