...
>
  ...
  const emit = defineEmits<{
    (e: 'dismiss'): void
    (e: 'action', action: ISnackbarStackItemAction): void
  }>()
  ...
  const actionClasses = (action: ISnackbarStackItemAction): Array<string> => {
   ...
   * Event handlers
   ********************************************************/
  const handleActionClick = (action: ISnackbarStackItemAction): void => {
    emit('action', action)
  }
