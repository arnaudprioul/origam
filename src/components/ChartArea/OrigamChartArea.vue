...
>
	...
	import type { IChartAreaProps } from '../../interfaces'
	 ...
	 * `type="area"` and exposes only area-relevant props.
	 ...
	 ********************************************************/
	defineOptions({
		name: 'OrigamChartArea',
		inheritAttrs: false
	})

	defineProps<IChartAreaProps>()
