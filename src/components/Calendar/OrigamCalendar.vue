...
>
	...
	function isCellToday (date: Date): boolean { return isToday(date) }
	function isCellPast (date: Date): boolean { return isPast(startOfDay(date)) && !isCellToday(date) }
	function isCellWeekend (date: Date): boolean { return isWeekend(date) }
	...
	function weekNumberOf (date: Date): number { return isoWeekNumber(date) }
	function ariaWeekNumberLabel (date: Date): string { return `Week ${weekNumberOf(date)}` }
	...
	function isSameDayLocal (a: Date, b: Date): boolean { return isSameDay(a, b) }
