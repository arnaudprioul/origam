<template>
	...
	>
		...
		<!--
			...
			when the parent panel expands. Stories below render it inside
			its parent so the open/close transition is observable.
		-->

		<Variant title="Default (text content prop)">
		...
		<Variant title="Lazy mode (mount on first open)">
